						                                            ...
						                                            <tbody>
						                                                ...
						                                                <tr>
						                                                	<td style="background-color: white; color: black; text-align: justify; font-family:'Courier New'; padding: 5px">
						                                                		...
						                                                		<p>
                                                                                    El equipo OMRI TE FELICITA por haber completado satisfactoriamente el curso de introducción a la programación. Ahora tienes ventajas para concursar próximamente con los mejores. 
                                                                                </p>
                                                                                <p>
                                                                                    El día 14 de septiembre, en la plataforma tendrás listo el siguiente curso. Da clic en <a href="https://entrenator.omri.org.mx/public/em/{{ $data['cr'] }}" target="_blank">este enlace para entrar a la plataforma</a>
                                                                                </p>
																				<p>
