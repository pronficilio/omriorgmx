						                                            ...
						                                            <tbody>
						                                                ...
						                                                <tr>
						                                                	<td style="background-color: white; color: black; text-align: justify; font-family:'Courier New'; padding: 5px">
																				...
																				<br>
																					<center>
																					<span style="background-color: #86c128; border-style: none; color: white; border-radius: 3px; font-size: 17px; height: 40px; width: 380px; font-family:'Consolas'"> <a href="https://entrenator.omri.org.mx" target="_blank"><strong>entrentator.omri.org.mx</strong></span>
																					</center>
																				<br>
                                                                                <p>
