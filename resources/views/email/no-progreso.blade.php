						                                            ...
						                                            <tbody>
						                                                ...
						                                                <tr>
						                                                	<td style="background-color: white; color: black; text-align: justify; font-family:'Courier New'; padding: 5px">
                                                                                ...
                                                                                <p>
                                                                                    ¡Da clic en <a href="https://entrenator.omri.org.mx/public/configura/{{ $data['email'] }}" target="_blank">https://entrenator.omri.org.mx/public/configura/{{ $data['email'] }}</a>
                                                                                     y comienza ahora! En esta plataforma también encontrarás juegos, videos de ayuda para solucionar los ejercicios, observar tus logros y puedes comparar tu progreso con el de tus compañeros de clase.
                                                                                </p>
																				<p>
																					<i>¡Este curso estará disponible por tiempo limitado! ¡No esperes más! </i>
																				</p>
