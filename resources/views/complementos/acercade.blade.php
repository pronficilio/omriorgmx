            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="ourpoints">
                    ...
                    <div class="">
                        ...
                        <div class="text-space text">
                            Reclutar jóvenes y niños talentosos del estado de Morelos para entrenarlos en programación competitiva
                        </div>
                    </div>
                    <div class="">
                        <div class="icon-space">
                        ...
                        <div class="text-space text">
                            Hacer que los mejores programadores del estado compitan en la Olimpiada Mexicana de Informática (OMI) y en la International Olympiad in Informatics (IOI), siendo esta ultima, organizada por la UNESCO.
                        </div>
                    </div>
                </div>
            </div>
